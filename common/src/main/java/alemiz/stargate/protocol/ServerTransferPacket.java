...
@ToString
public class ServerTransferPacket extends StarGatePacket {
    ...
    public void encodePayload(ByteBuf byteBuf) {
        ...
        PacketHelper.writeString(byteBuf, this.targetServer);
    }

    @Override
    public void decodePayload(ByteBuf byteBuf) {
        this.playerName = PacketHelper.readString(byteBuf);
        this.targetServer = PacketHelper.readString(byteBuf);
    }
